...
const data = [{"id":1,"title":"Cosmos","detail":"Maecenas ut massa quis augue luctus tincidunt. Nulla mollis molestie lorem. Quisque ut erat.","img":"http://dummyimage.com/450x300.png/5fa2dd/ffffff","price":13,"stock":48},
    ...
    {"id":10,"title":"Fall of the Republic: The Presidency of Barack H. Obama","detail":"Vestibulum quam sapien, varius ut, blandit non, interdum in, ante. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Duis faucibus accumsan odio. Curabitur convallis.\n\nDuis consequat dui nec nisi volutpat eleifend. Donec ut dolor. Morbi vel lectus in quam fringilla rhoncus.","img":"http://dummyimage.com/450x300.png/dddddd/000000","price":84,"stock":9},
    {"id":11,"title":"Ed Wood","detail":"Praesent id massa id nisl venenatis lacinia. Aenean sit amet justo. Morbi ut odio.\n\nCras mi pede, malesuada in, imperdiet et, commodo vulputate, justo. In blandit ultrices enim. Lorem ipsum dolor sit amet, consectetuer adipiscing elit.","img":"http://dummyimage.com/450x300.png/5fa2dd/ffffff","price":62,"stock":87},
    {"id":12, "title":"Choke","detail":"Curabitur in libero ut massa volutpat convallis. Morbi odio odio, elementum eu, interdum eu, tincidunt in, leo. Maecenas pulvinar lobortis est.\n\nPhasellus sit amet erat. Nulla tempus. Vivamus in felis eu sapien cursus vestibulum.","img":"http://dummyimage.com/450x300.png/dddddd/000000","price":35,"stock":3}]

let url = window.location.href.split("=")[1]

const filtrarProducto = data.filter((prod) => prod.id === url);

const card = `
<div class="card mb-3" style="width: 18rem;">
<a href="#"><img src="${filtrarProducto[0].img}" class="card-img-top img-fluid" style="height: 200px; object-fit: cover;" alt="${producto.id}"></a>
<div class="card-body">
<h5 class="card-title">${filtrarProducto[0].title} </h5>
<p class="card-text">${filtrarProducto[0].detail}</p>
<p class="card-text">$${filtrarProducto[0].price}</p>
<p class="card-text">${filtrarProducto[0].stock}</p>
<a href="producto.html?prod=${filtrarProducto[0].id}" class="btn btn-primary bg-secondary border-0">Ver más</a>
</div>
</div>`;
